...
export default function LogoLinkedin({ className, hoverEffects = true }) {
    ...
    >
      <g id="g5891">
        <path
          ...
          id="background"
          style={{
            fill: hoverEffects && hasHover ? "#2867b2" : "currentcolor",
          }}
        />
        <g id="shapes">
          <rect
            height="257.962"
            id="rect11"
            style={{ fill: hoverEffects && hasHover ? "#fff" : "#121212" }}
            width="85.76"
            x="61.053"
            y="178.667"
          />
          <path
            ...
            id="path13-0"
            style={{
              fill: hoverEffects && hasHover ? "#fff" : "#121212",
              fillRule: "nonzero",
            }}
          />
          <path
